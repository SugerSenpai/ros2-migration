...
#ifndef COB_SRVS__SRV__DETAIL__SET_STRING__FUNCTIONS_H_
#define COB_SRVS__SRV__DETAIL__SET_STRING__FUNCTIONS_H_
 ...
 * calls
 * cob_srvs__srv__SetString_Request__init().
...
/**
 * It calls
 * cob_srvs__srv__SetString_Request__fini()
 ...
 * cob_srvs__srv__SetString_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * cob_srvs__srv__SetString_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cob_srvs__srv__SetString_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cob_srvs
...
/**
 * It calls
 * cob_srvs__srv__SetString_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_cob_srvs
...
/**
 * It allocates the memory for the array and calls
 * cob_srvs__srv__SetString_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cob_srvs
...
/**
 * It calls
 * cob_srvs__srv__SetString_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COB_SRVS__SRV__DETAIL__SET_STRING__FUNCTIONS_H_

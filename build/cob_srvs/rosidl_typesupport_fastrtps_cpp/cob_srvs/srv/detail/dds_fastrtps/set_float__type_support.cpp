...
#include "cob_srvs/srv/detail/set_float__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cob_srvs::srv::SetFloat_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cob_srvs::srv::SetFloat_Request & ros_message)
{
  // Member: data
  cdr >> ros_message.data;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cob_srvs::srv::SetFloat_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cob_srvs::srv::SetFloat_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cob_srvs::srv::SetFloat_Request *>(
    untyped_ros_message);
...
{
  return &cob_srvs::srv::typesupport_fastrtps_cpp::_SetFloat_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cob_srvs, srv, SetFloat_Request)() {
  return &cob_srvs::srv::typesupport_fastrtps_cpp::_SetFloat_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cob_srvs
cdr_serialize(
  const cob_srvs::srv::SetFloat_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cob_srvs::srv::SetFloat_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cob_srvs::srv::SetFloat_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cob_srvs::srv::SetFloat_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cob_srvs::srv::SetFloat_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cob_srvs::srv::typesupport_fastrtps_cpp::_SetFloat_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cob_srvs, srv, SetFloat_Response)() {
  return &cob_srvs::srv::typesupport_fastrtps_cpp::_SetFloat_Response__handle;
}
...
{
  return &cob_srvs::srv::typesupport_fastrtps_cpp::_SetFloat__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cob_srvs, srv, SetFloat)() {
  return &cob_srvs::srv::typesupport_fastrtps_cpp::_SetFloat__handle;
}

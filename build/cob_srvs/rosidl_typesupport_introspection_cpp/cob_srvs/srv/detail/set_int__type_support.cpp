...
{
  new (message_memory) cob_srvs::srv::SetInt_Request(_init);
}

void SetInt_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cob_srvs::srv::SetInt_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetInt_Request_message_member_array[1] = {
  {
    ...
    offsetof(cob_srvs::srv::SetInt_Request, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetInt_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(cob_srvs::srv::SetInt_Request),
...
get_message_type_support_handle<cob_srvs::srv::SetInt_Request>()
{
  return &::cob_srvs::srv::rosidl_typesupport_introspection_cpp::SetInt_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cob_srvs, srv, SetInt_Request)() {
  return &::cob_srvs::srv::rosidl_typesupport_introspection_cpp::SetInt_Request_message_type_support_handle;
}
...
void SetInt_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) cob_srvs::srv::SetInt_Response(_init);
}

void SetInt_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cob_srvs::srv::SetInt_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetInt_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cob_srvs::srv::SetInt_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cob_srvs::srv::SetInt_Response, message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetInt_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(cob_srvs::srv::SetInt_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<cob_srvs::srv::SetInt_Response>()
{
  return &::cob_srvs::srv::rosidl_typesupport_introspection_cpp::SetInt_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cob_srvs, srv, SetInt_Response)() {
  return &::cob_srvs::srv::rosidl_typesupport_introspection_cpp::SetInt_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SetInt_service_members = {
  ...
  // see get_service_type_support_handle<cob_srvs::srv::SetInt>()
...
get_service_type_support_handle<cob_srvs::srv::SetInt>()
{
  // get a handle to the value to be returned
  auto service_type_support =
    &::cob_srvs::srv::rosidl_typesupport_introspection_cpp::SetInt_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cob_srvs, srv, SetInt)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<cob_srvs::srv::SetInt>();
}

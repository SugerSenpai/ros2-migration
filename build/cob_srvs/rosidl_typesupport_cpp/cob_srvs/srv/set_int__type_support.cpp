...
static const _SetInt_Request_type_support_symbol_names_t _SetInt_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cob_srvs, srv, SetInt_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cob_srvs, srv, SetInt_Request)),
  }
};
...
{
  return &::cob_srvs::srv::rosidl_typesupport_cpp::SetInt_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cob_srvs, srv, SetInt_Request)() {
  return get_message_type_support_handle<cob_srvs::srv::SetInt_Request>();
}
...
static const _SetInt_Response_type_support_symbol_names_t _SetInt_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cob_srvs, srv, SetInt_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cob_srvs, srv, SetInt_Response)),
  }
};
...
{
  return &::cob_srvs::srv::rosidl_typesupport_cpp::SetInt_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cob_srvs, srv, SetInt_Response)() {
  return get_message_type_support_handle<cob_srvs::srv::SetInt_Response>();
}
...
static const _SetInt_type_support_symbol_names_t _SetInt_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cob_srvs, srv, SetInt)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cob_srvs, srv, SetInt)),
  }
};
...
{
  return &::cob_srvs::srv::rosidl_typesupport_cpp::SetInt_service_type_support_handle;
}

...
static const _Dock_Request_type_support_symbol_names_t _Dock_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cob_srvs, srv, Dock_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cob_srvs, srv, Dock_Request)),
  }
};
...
{
  return &::cob_srvs::srv::rosidl_typesupport_cpp::Dock_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cob_srvs, srv, Dock_Request)() {
  return get_message_type_support_handle<cob_srvs::srv::Dock_Request>();
}
...
static const _Dock_Response_type_support_symbol_names_t _Dock_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cob_srvs, srv, Dock_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cob_srvs, srv, Dock_Response)),
  }
};
...
{
  return &::cob_srvs::srv::rosidl_typesupport_cpp::Dock_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cob_srvs, srv, Dock_Response)() {
  return get_message_type_support_handle<cob_srvs::srv::Dock_Response>();
}
...
static const _Dock_type_support_symbol_names_t _Dock_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cob_srvs, srv, Dock)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cob_srvs, srv, Dock)),
  }
};
...
{
  return &::cob_srvs::srv::rosidl_typesupport_cpp::Dock_service_type_support_handle;
}

...
#include "cob_base_controller_utils/msg/detail/wheel_commands__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.drive_target_velocity;
  }
  // Member: steer_target_velocity
  {
    cdr << ros_message.steer_target_velocity;
  }
  // Member: steer_target_position
  {
    cdr << ros_message.steer_target_position;
  }
  // Member: steer_target_error
  {
    cdr << ros_message.steer_target_error;
  }
  return true;
}
  ...
  size_t current_alignment)
{
  ...
  // Member: drive_target_velocity
  {
    ...
    size_t item_size = sizeof(ros_message.drive_target_velocity[0]);
  ...
  // Member: steer_target_velocity
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.steer_target_velocity[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: steer_target_position
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.steer_target_position[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: steer_target_error
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.steer_target_error[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cob_base_controller_utils::msg::WheelCommands;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cob_base_controller_utils::msg::WheelCommands *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cob_base_controller_utils::msg::WheelCommands *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_cob_base_controller_utils
const rosidl_message_type_support_t *
get_message_type_support_handle<cob_base_controller_utils::msg::WheelCommands>()
{
  return &cob_base_controller_utils::msg::typesupport_fastrtps_cpp::_WheelCommands__handle;
}

...
#include "cob_base_controller_utils/msg/detail/wheel_commands__type_support.h"
...
static const _WheelCommands_type_support_symbol_names_t _WheelCommands_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cob_base_controller_utils, msg, WheelCommands)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cob_base_controller_utils, msg, WheelCommands)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cob_base_controller_utils, msg, WheelCommands)() {
  return &::cob_base_controller_utils::msg::rosidl_typesupport_c::WheelCommands_message_type_support_handle;
}

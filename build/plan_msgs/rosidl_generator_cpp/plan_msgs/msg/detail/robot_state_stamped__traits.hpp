...
// Member 'header'
#include "plan_msgs/msg/detail/header__traits.hpp"
// Member 'state'
...
struct has_fixed_size<plan_msgs::msg::RobotStateStamped>
  : std::integral_constant<bool, has_fixed_size<plan_msgs::msg::Header>::value && has_fixed_size<plan_msgs::msg::RobotState>::value> {};

template<>
struct has_bounded_size<plan_msgs::msg::RobotStateStamped>
  : std::integral_constant<bool, has_bounded_size<plan_msgs::msg::Header>::value && has_bounded_size<plan_msgs::msg::RobotState>::value> {};

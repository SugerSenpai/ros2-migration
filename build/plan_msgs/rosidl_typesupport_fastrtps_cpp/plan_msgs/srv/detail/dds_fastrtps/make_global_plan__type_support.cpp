...
#include "plan_msgs/srv/detail/make_global_plan__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = plan_msgs::srv::MakeGlobalPlan_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const plan_msgs::srv::MakeGlobalPlan_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<plan_msgs::srv::MakeGlobalPlan_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MakeGlobalPlan_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const plan_msgs::srv::MakeGlobalPlan_Request *>(
...
static size_t _MakeGlobalPlan_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MakeGlobalPlan_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MakeGlobalPlan_Request__callbacks = {
  "plan_msgs::srv",
...
static rosidl_message_type_support_t _MakeGlobalPlan_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MakeGlobalPlan_Request__callbacks,
...
{
  return &plan_msgs::srv::typesupport_fastrtps_cpp::_MakeGlobalPlan_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = plan_msgs::srv::MakeGlobalPlan_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const plan_msgs::srv::MakeGlobalPlan_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<plan_msgs::srv::MakeGlobalPlan_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MakeGlobalPlan_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const plan_msgs::srv::MakeGlobalPlan_Response *>(
...
static size_t _MakeGlobalPlan_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MakeGlobalPlan_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MakeGlobalPlan_Response__callbacks = {
  "plan_msgs::srv",
...
static rosidl_message_type_support_t _MakeGlobalPlan_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MakeGlobalPlan_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &plan_msgs::srv::typesupport_fastrtps_cpp::_MakeGlobalPlan_Response__handle;
}
...
static service_type_support_callbacks_t _MakeGlobalPlan__callbacks = {
  "plan_msgs::srv",
  "MakeGlobalPlan",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, plan_msgs, srv, MakeGlobalPlan_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, plan_msgs, srv, MakeGlobalPlan_Response)(),
...
static rosidl_service_type_support_t _MakeGlobalPlan__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MakeGlobalPlan__callbacks,
...
{
  return &plan_msgs::srv::typesupport_fastrtps_cpp::_MakeGlobalPlan__handle;
}

...
#ifndef COB_CONTROL_MSGS__SRV__DETAIL__GET_OBSTACLE_DISTANCE__FUNCTIONS_H_
#define COB_CONTROL_MSGS__SRV__DETAIL__GET_OBSTACLE_DISTANCE__FUNCTIONS_H_
...
#include "cob_control_msgs/srv/detail/get_obstacle_distance__struct.h"

/// Initialize srv/GetObstacleDistance message.
/**
...
/// Finalize srv/GetObstacleDistance message.
/**
...
/// Create srv/GetObstacleDistance message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cob_control_msgs__srv__GetObstacleDistance_Request__init().
...
/// Destroy srv/GetObstacleDistance message.
/**
 * It calls
 * cob_control_msgs__srv__GetObstacleDistance_Request__fini()
...
/// Check for srv/GetObstacleDistance message equality.
/**
...
/// Copy a srv/GetObstacleDistance message.
/**
...
/// Initialize array of srv/GetObstacleDistance messages.
/**
...
/// Finalize array of srv/GetObstacleDistance messages.
/**
 * It calls
 * cob_control_msgs__srv__GetObstacleDistance_Request__fini()
...
/// Create array of srv/GetObstacleDistance messages.
/**
 * It allocates the memory for the array and calls
 * cob_control_msgs__srv__GetObstacleDistance_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetObstacleDistance messages.
/**
 * It calls
 * cob_control_msgs__srv__GetObstacleDistance_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetObstacleDistance message array equality.
/**
...
/// Copy an array of srv/GetObstacleDistance messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cob_control_msgs__srv__GetObstacleDistance_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cob_control_msgs
...
/**
 * It calls
 * cob_control_msgs__srv__GetObstacleDistance_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_cob_control_msgs
...
/**
 * It allocates the memory for the array and calls
 * cob_control_msgs__srv__GetObstacleDistance_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cob_control_msgs
...
/**
 * It calls
 * cob_control_msgs__srv__GetObstacleDistance_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COB_CONTROL_MSGS__SRV__DETAIL__GET_OBSTACLE_DISTANCE__FUNCTIONS_H_

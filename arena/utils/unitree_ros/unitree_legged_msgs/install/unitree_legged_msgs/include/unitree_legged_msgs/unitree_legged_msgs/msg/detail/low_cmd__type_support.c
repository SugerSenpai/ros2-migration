...
size_t unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__size_function__LowCmd__motorcmd(
  const void * untyped_member)
{
  (void)untyped_member;
  return 20;
...
const void * unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__get_const_function__LowCmd__motorcmd(
  const void * untyped_member, size_t index)
{
...
void * unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__get_function__LowCmd__motorcmd(
  void * untyped_member, size_t index)
{
...
void unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__fetch_function__LowCmd__motorcmd(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const unitree_legged_msgs__msg__MotorCmd * item =
    ((const unitree_legged_msgs__msg__MotorCmd *)
    unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__get_const_function__LowCmd__motorcmd(untyped_member, index));
  unitree_legged_msgs__msg__MotorCmd * value =
    (unitree_legged_msgs__msg__MotorCmd *)(untyped_value);
  *value = *item;
}

void unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__assign_function__LowCmd__motorcmd(
  void * untyped_member, size_t index, const void * untyped_value)
{
  unitree_legged_msgs__msg__MotorCmd * item =
    ((unitree_legged_msgs__msg__MotorCmd *)
    unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__get_function__LowCmd__motorcmd(untyped_member, index));
  const unitree_legged_msgs__msg__MotorCmd * value =
    (const unitree_legged_msgs__msg__MotorCmd *)(untyped_value);
  *item = *value;
}

size_t unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__size_function__LowCmd__wirelessremote(
  const void * untyped_member)
{
  (void)untyped_member;
  return 40;
...
const void * unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__get_const_function__LowCmd__wirelessremote(
  const void * untyped_member, size_t index)
{
  const uint8_t * member =
    (const uint8_t *)(untyped_member);
...
void * unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__get_function__LowCmd__wirelessremote(
  void * untyped_member, size_t index)
{
  uint8_t * member =
    (uint8_t *)(untyped_member);
...
void unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__fetch_function__LowCmd__wirelessremote(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const uint8_t * item =
    ((const uint8_t *)
    unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__get_const_function__LowCmd__wirelessremote(untyped_member, index));
  uint8_t * value =
    (uint8_t *)(untyped_value);
  *value = *item;
}

void unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__assign_function__LowCmd__wirelessremote(
  void * untyped_member, size_t index, const void * untyped_value)
{
  uint8_t * item =
    ((uint8_t *)
    unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__get_function__LowCmd__wirelessremote(untyped_member, index));
  const uint8_t * value =
    (const uint8_t *)(untyped_value);
  *item = *value;
}
...
static rosidl_typesupport_introspection_c__MessageMember unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__LowCmd_message_member_array[11] = {
  ...
  },
  {
    ...
    NULL,  // default value
    unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__size_function__LowCmd__motorcmd,  // size() function pointer
    unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__get_const_function__LowCmd__motorcmd,  // get_const(index) function pointer
    unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__get_function__LowCmd__motorcmd,  // get(index) function pointer
    unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__fetch_function__LowCmd__motorcmd,  // fetch(index, &value) function pointer
    unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__assign_function__LowCmd__motorcmd,  // assign(index, value) function pointer
    NULL  // resize(index) function pointer
  },
  {
    "bms",  // name
  ...
  },
  {
    ...
    NULL,  // default value
    unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__size_function__LowCmd__wirelessremote,  // size() function pointer
    unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__get_const_function__LowCmd__wirelessremote,  // get_const(index) function pointer
    unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__get_function__LowCmd__wirelessremote,  // get(index) function pointer
    unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__fetch_function__LowCmd__wirelessremote,  // fetch(index, &value) function pointer
    unitree_legged_msgs__msg__LowCmd__rosidl_typesupport_introspection_c__assign_function__LowCmd__wirelessremote,  // assign(index, value) function pointer
    NULL  // resize(index) function pointer
  },
  {
    "reserve",  // name

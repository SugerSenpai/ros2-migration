...
#ifndef MAP_DISTANCE_SERVER__SRV__DETAIL__GET_DISTANCE_MAP__FUNCTIONS_H_
#define MAP_DISTANCE_SERVER__SRV__DETAIL__GET_DISTANCE_MAP__FUNCTIONS_H_
...
#include "map_distance_server/msg/rosidl_generator_c__visibility_control.h"

#include "map_distance_server/srv/detail/get_distance_map__struct.h"

/// Initialize srv/GetDistanceMap message.
/**
...
/// Create srv/GetDistanceMap message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * map_distance_server__srv__GetDistanceMap_Request__init().
...
/// Destroy srv/GetDistanceMap message.
/**
 * It calls
 * map_distance_server__srv__GetDistanceMap_Request__fini()
...
/// Check for srv/GetDistanceMap message equality.
/**
...
/// Copy a srv/GetDistanceMap message.
/**
...
/// Initialize array of srv/GetDistanceMap messages.
/**
...
/// Finalize array of srv/GetDistanceMap messages.
/**
 * It calls
 * map_distance_server__srv__GetDistanceMap_Request__fini()
...
/// Create array of srv/GetDistanceMap messages.
/**
 * It allocates the memory for the array and calls
 * map_distance_server__srv__GetDistanceMap_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetDistanceMap messages.
/**
 * It calls
 * map_distance_server__srv__GetDistanceMap_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetDistanceMap message array equality.
/**
...
/// Copy an array of srv/GetDistanceMap messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * map_distance_server__srv__GetDistanceMap_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_map_distance_server
...
/**
 * It calls
 * map_distance_server__srv__GetDistanceMap_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_map_distance_server
...
/**
 * It allocates the memory for the array and calls
 * map_distance_server__srv__GetDistanceMap_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_map_distance_server
...
/**
 * It calls
 * map_distance_server__srv__GetDistanceMap_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MAP_DISTANCE_SERVER__SRV__DETAIL__GET_DISTANCE_MAP__FUNCTIONS_H_

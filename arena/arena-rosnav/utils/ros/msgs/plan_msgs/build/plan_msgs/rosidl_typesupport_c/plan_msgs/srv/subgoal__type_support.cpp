...
static const _Subgoal_Request_type_support_symbol_names_t _Subgoal_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plan_msgs, srv, Subgoal_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plan_msgs, srv, Subgoal_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, plan_msgs, srv, Subgoal_Request)() {
  return &::plan_msgs::srv::rosidl_typesupport_c::Subgoal_Request_message_type_support_handle;
}
...
static const _Subgoal_Response_type_support_symbol_names_t _Subgoal_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plan_msgs, srv, Subgoal_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plan_msgs, srv, Subgoal_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, plan_msgs, srv, Subgoal_Response)() {
  return &::plan_msgs::srv::rosidl_typesupport_c::Subgoal_Response_message_type_support_handle;
}
...
static const _Subgoal_type_support_symbol_names_t _Subgoal_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plan_msgs, srv, Subgoal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plan_msgs, srv, Subgoal)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, plan_msgs, srv, Subgoal)() {
  return &::plan_msgs::srv::rosidl_typesupport_c::Subgoal_service_type_support_handle;
}

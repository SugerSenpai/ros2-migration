...
bool plan_msgs__msg__robot_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("plan_msgs.msg._robot_state.RobotState", full_classname_dest, 37) == 0);
  }
  plan_msgs__msg__RobotState * ros_message = _ros_message;
  {  // pose
...
PyObject * plan_msgs__msg__robot_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("plan_msgs.msg._robot_state");

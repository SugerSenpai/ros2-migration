...
#include "plan_msgs/msg/detail/robot_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = plan_msgs::msg::RobotState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const plan_msgs::msg::RobotState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<plan_msgs::msg::RobotState *>(
    untyped_ros_message);
...
{
  return &plan_msgs::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}

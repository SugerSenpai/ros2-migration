...
static const _RobotStateStamped_type_support_symbol_names_t _RobotStateStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, plan_msgs, msg, RobotStateStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, plan_msgs, msg, RobotStateStamped)),
  }
};
...
{
  return &::plan_msgs::msg::rosidl_typesupport_cpp::RobotStateStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, plan_msgs, msg, RobotStateStamped)() {
  return get_message_type_support_handle<plan_msgs::msg::RobotStateStamped>();
}

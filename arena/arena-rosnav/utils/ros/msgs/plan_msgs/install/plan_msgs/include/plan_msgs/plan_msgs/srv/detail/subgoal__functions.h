...
#ifndef PLAN_MSGS__SRV__DETAIL__SUBGOAL__FUNCTIONS_H_
#define PLAN_MSGS__SRV__DETAIL__SUBGOAL__FUNCTIONS_H_
...
/// Initialize srv/Subgoal message.
/**
...
/// Create srv/Subgoal message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * plan_msgs__srv__Subgoal_Request__init().
...
/// Destroy srv/Subgoal message.
/**
 * It calls
 * plan_msgs__srv__Subgoal_Request__fini()
...
/// Check for srv/Subgoal message equality.
/**
...
/// Initialize array of srv/Subgoal messages.
/**
...
/// Finalize array of srv/Subgoal messages.
/**
 * It calls
 * plan_msgs__srv__Subgoal_Request__fini()
...
/// Create array of srv/Subgoal messages.
/**
 * It allocates the memory for the array and calls
 * plan_msgs__srv__Subgoal_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Subgoal messages.
/**
 * It calls
 * plan_msgs__srv__Subgoal_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Subgoal message array equality.
/**
...
/// Copy an array of srv/Subgoal messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * plan_msgs__srv__Subgoal_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_plan_msgs
...
/**
 * It calls
 * plan_msgs__srv__Subgoal_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_plan_msgs
...
/**
 * It allocates the memory for the array and calls
 * plan_msgs__srv__Subgoal_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_plan_msgs
...
/**
 * It calls
 * plan_msgs__srv__Subgoal_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PLAN_MSGS__SRV__DETAIL__SUBGOAL__FUNCTIONS_H_
